    ...
    <AnimatePresence>
      {selectedClaim && (
        <motion.div
          ...
          className="fixed top-0 right-0 w-full sm:w-[480px] h-full bg-white shadow-2xl z-50 flex flex-col"
        >
          {/* Header */}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="mt-2 flex flex-wrap items-center gap-2">
                                ...
                                {activity.fromStatus && (
                                  <span
                                    className={`text-xs px-2 py-1 rounded-full ${statusBadgeClass(
                                      activity.fromStatus
                                    )}`}
                                  >
                                    {uiStatusLabel(activity.fromStatus)}
                                  </span>
                                )}
                                ...
                                {activity.toStatus && (
                                  ...
                                  >
                                    {uiStatusLabel(activity.toStatus)}
                                  </span>
                                )}
                              </div>
